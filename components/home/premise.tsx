  ...
  return (
    <Section>
      <Reveal className="mx-auto max-w-3xl">
        <p className="mb-6 font-sans label-b uppercase tracking-[0.18em] text-muted">
          Why we&rsquo;re building {APP_NAME}
        </p>

        <blockquote className="h3-m text-text">
          ...
          <span className="text-text-light">
            {APP_NAME} is that place — built one cohort at a time, around what
            people actually want to learn.
          </span>
        </blockquote>
